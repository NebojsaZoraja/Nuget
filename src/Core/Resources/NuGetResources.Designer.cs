...
namespace NuGet.Resources {
    ...
    internal class NuGetResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Unable to resolve dependency {0} for package {1}.
        /// </summary>
        internal static string UnableToResolveDependencyForPackage {
            get {
                return ResourceManager.GetString("UnableToResolveDependencyForPackage", resourceCulture);
            }
        }
